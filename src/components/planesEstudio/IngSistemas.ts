export const planIngSistemas = [
    ...
    { codigo: "3011166", nombre: "Fundamentos de Sistemas de Información e Inteligencia de Negocios", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007854", nombre: "Técnicas de Aprendizaje Estadístico", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007860", nombre: "Sistema de Recuperación de Información de web", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007862", nombre: "Visión Artificial", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3009150", nombre: "Redes Neuronales Artificiales y Algoritmos Bioinspirados", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3009151", nombre: "Introducción a la Robótica", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007850", nombre: "Diseño y Construcción de Productos de Software", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007848", nombre: "Bases de Datos II", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3009430", nombre: "Análisis y Diseño de Algoritmos", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007871", nombre: "Programación Matemática", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007872", nombre: "Sistemas Complejos", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007325", nombre: "Investigación de Operaciones II", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007311", nombre: "Dinámica de Sistemas", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007873", nombre: "Teoría de la Organización Industrial", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3007851", nombre: "Gestión de Proyectos de Software", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3010836", nombre: "Cátedra de Sistemas: una Visión Histórico-Cultural de la Computación", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3010757", nombre: "Ciencias de la Computación y Aplicaciones Móviles", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3010585", nombre: "Creación de Videojuegos", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3009936", nombre: "Seguridad Web", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3011172", nombre: "Desarrollo Web II", creditos: 3, tipologia: "O - Fundamentación Optativa" },
    { codigo: "3011093", nombre: "Computación Paralela", creditos: 3, tipologia: "O - Fundamentación Optativa" }
];